...
import { ArrowLeft, Calendar, CalendarClock, Info, Link, PlayCircle, Video } from "lucide-vue-next";

import { Button } from "@/components/ui/button";
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card";

import { useFormatters } from "@/composables/useFormatters";
import type { Video as VideoType } from "@/lib/api/types/video.types";
...
interface Emits {
  (e: "back"): void;
  (e: "edit", video: VideoType): void;
  (e: "delete", video: VideoType): void;
}
      ...
      <CardHeader>
        <div class="flex items-start gap-4">
          <div class="flex h-16 w-16 items-center justify-center rounded-full bg-red-100">
            <PlayCircle class="h-8 w-8 text-red-600" />
          </div>
          <div class="flex-1">
