...
<template>
  <div :class="['flex flex-col gap-6', props.class]">
    <Card class="!shadow-login overflow-hidden py-0">
      <CardContent class="grid p-0 md:grid-cols-2">
        ...
        >
          <div class="flex flex-col gap-6">
            ...
            <div class="flex flex-col items-center text-center">
              ...
              <p class="text-muted-foreground text-balance">Login ke akun Anda</p>
            </div>
            ...
            >
              <span class="bg-background text-muted-foreground relative z-10 px-2"> Atau login dengan </span>
            </div>
            ...
            <div class="grid grid-cols-3 gap-4">
              <Button variant="outline" class="w-full">
                ...
                <span class="sr-only">Login dengan Apple</span>
              </Button>
              ...
              <Button variant="outline" class="w-full">
                ...
                <span class="sr-only">Login dengan Meta (Facebook)</span>
              </Button>
            </div>
        ...
        <!-- Right side image -->
        <div class="bg-muted relative hidden md:flex md:items-center md:justify-center">
          <img
            src="/assets/images/logos/logo-kukar.png"
            alt="Kukar Logo"
            class="max-h-80 max-w-xs object-contain dark:brightness-[0.2] dark:grayscale"
          />
        </div>
      </CardContent>
    </Card>
