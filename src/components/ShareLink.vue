<template>
  <div class="flex flex-wrap gap-2">
    ...
    <a
      ...
      class="inline-flex items-center gap-2 rounded-lg bg-sky-500 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-sky-600"
      target="_blank"
    >
      <svg height="20" width="20" viewBox="0 0 24 24">
        <path
    ...
    <a
      href="mailto:"
      class="inline-flex items-center gap-2 rounded-lg bg-gray-600 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-gray-700"
      target="_blank"
    >
      <svg height="20" width="20" viewBox="0 0 24 24">
        <path
