    ...
    <main class="py-12">
      <div class="container">
        ...
        <div v-else-if="data">
              ...
              >
                ...
                <div class="p-4">
                  ...
                  <div class="mb-3 flex items-center text-sm text-gray-500">
                    ...
                    <span>{{ formatters.date(radio.createdAt) }}</span>
                  </div>
                  ...
                  <a
                    ...
                    style="
                      ...
                      overflow: hidden;
                    "
                    @click.prevent="openVideoModal(formatters.toEmbedUrl(radio.link))"
                  >
                    {{ radio.judul }}
                  </a>
                  ...
                  <!-- Play Button -->
                  <button
                    @click="openVideoModal(formatters.toEmbedUrl(radio.link))"
          ...
          <!-- Empty State for no radios -->
          <template v-else>
            <div class="mx-auto max-w-2xl">
              <div class="rounded border border-yellow-200 bg-yellow-50 p-8 text-center">
                <i class="bx bx-file-blank mb-4 text-4xl text-yellow-600"></i>
                <h4 class="mb-4 text-xl font-semibold text-yellow-800">Tidak Ada Radio</h4>
