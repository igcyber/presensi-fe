...
import { getTugasFungsi, type TugasFungsiData, type TugasFungsiResponse } from "@/lib/api/pemerintahan";

const { data, isLoading, fetchData, isError, error } = useFetch<TugasFungsiResponse, TugasFungsiData>(getTugasFungsi, {
  immediate: false,
