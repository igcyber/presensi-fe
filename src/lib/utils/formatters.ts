...
export function formatStatus(
  ...
  const statusClasses: Record<string, string> = {
    ...
    proses: "bg-yellow-100 text-yellow-600 dark:bg-yellow-600 dark:text-yellow-300",
    pending: "bg-yellow-100 text-yellow-600 dark:bg-yellow-600 dark:text-yellow-300",
